...
Model on `src/components/page-sections/heroes/hero-center/HeroCenter.astro`. Page sections wrap content in `CustomSection` and compose existing building blocks — do not hand-write section chrome.
