...
- A **Getting there** walkthrough on `/introduction/` and a **Common questions** FAQ on `/installation/`, built from the Steps and FAQ page sections. Both sit in the prose with their section chrome switched off, their heading written as a Markdown `##` so the on-this-page rail lists it.
