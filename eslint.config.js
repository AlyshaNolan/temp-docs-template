...
export default [
  ...
  // Global ignores
  {
    ignores: [
      ...
      "**/content.d.ts",
      "**/types.d.ts",
      // Local dev search index generated by `npm run search:dev` (gitignored).
      "public/pagefind/**",
      // Agent worktrees are checkouts of this repo — lint them from inside.
      ".claude/worktrees/**",
      // Reference material, not part of the site.
      "resources-temp/**",
      "alto-hugo-template-main/**",
    ],
  },
];
